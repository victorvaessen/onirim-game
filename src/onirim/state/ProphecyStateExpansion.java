 ...
 * @author Bino
 */
public class ProphecyStateExpansion implements State {

    private OnirimExpansion onirim;
    Scanner sc = new Scanner(System.in);
    private String aux;

    public ProphecyStateExpansion(OnirimExpansion onirim) {
        this.onirim = onirim;
    }
    ...
    public void event() {
        ...
        if (onirim.getDiscardStack().ShowLastCard().getType().equalsIgnoreCase("LABYRINTH")) {
            //prophecy key labyrinth
            ...
            //Prophecy tower
            cards.addAll(onirim.getDeck().showTopCards(((Tower) onirim.getDiscardStack().ShowLastCard()).getNumber()));
